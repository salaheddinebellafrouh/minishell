...
EXECUTION = ./execution/execute_built_ins.c ./execution/execve.c ./execution/execve_helpers.c ./execution/redirection.c
PARSING = ./parsing/ft_free.c ./parsing/ft_expand.c ./parsing/ft_helpers.c  \
		...
		Utils_4.c ./parsing/init_var.c ./parsing/calloc_before_after.c
